...
/>
<h1 className='bold-52 lg:bold-88'>Putuk Truno <br/> Camp Area</h1>
...
<p className='bold-16 lg:bold-20 text-blue-70'> 198k
  <span className='regular-16 ml-1'> Excellent Reviews</span>
</p>
</div>
<div className='flex flex-col w-full items-center gap-3 sm:flex-row'>
<Button 
type='button' 
title="Download App" 
variant='btn_green'
...
<div className='relative z-20 w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8'>
  ...
  src="/close.svg"
   ...
   />
    ...
    <p className='bold-20 text-white mb-5'>Aguas Calientes</p>
    <div className='flex justify-between'>
    <div className='flex flex-col'>
        <p className='regular-16 block text-gray-20'>Distance</p>
        <p className='bold-20 text-white'>173.32 mi</p>
    </div>
    <div className='flex flex-col'>
